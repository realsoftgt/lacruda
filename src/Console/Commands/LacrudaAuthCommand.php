...
namespace RealSoft\Lacruda\Console\Commands;

use Illuminate\Console\Command;
use Illuminate\Filesystem\Filesystem;

class LacrudaAuthCommand extends Command
{
    protected $signature = 'lacruda:auth';
    ...
    private function insertTraits()
    {
        ...
        foreach ($controller_traits as $controller => $trait) {
            ...
            $replace = '\\RealSoft\\Lacruda\\Traits\\Auth\\Lacruda' . $controller;
    ...
    private function insertHomeRoute()
    {
        ...
        $route = "Route::get('/home', '\RealSoft\Lacruda\Http\Controllers\LacrudaHomeController@index')->name('home');";
